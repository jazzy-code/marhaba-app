...
import { Archive, MessageCircleMore } from "lucide-react"

import { setAuthToken } from "@/api/apiClient"
import { archiveInquiry, getInquiries } from "@/api/inquiries/inquiries.client"
...
const InquiriesPage: FC<ListPageProps> = ({ initialData }) => {
  ...
  const {
    ...
    queryKey: ["inquiries", inquiriesParams],
    queryFn: async () => {
      const token = await getToken()
      setAuthToken(token)
      return getInquiries({ ...inquiriesParams })
    },
