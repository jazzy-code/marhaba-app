...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 z-50 w-full transition-all duration-300 h-24 flex items-center ${
      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 lg:px-8">
        <div className="flex items-center gap-4 cursor-pointer" onClick={() => navigate("/")}>
          <div
            className={`flex size-10 items-center justify-center ${scrolled || !isHome ? "text-deep-brown" : "text-white"}`}>
            <svg
          ...
          <h2
            className={`font-display text-lg font-bold tracking-widest drop-shadow-md ${scrolled || !isHome ? "text-deep-brown" : "text-white"}`}>
            MARHABA
          </h2>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div className="hidden md:flex items-center gap-4">
            <button
              className={`${scrolled || !isHome ? "text-brand-primary" : "text-white"} hover:opacity-80 transition-colors`}>
          ...
          <button
            ...
            className={`lg:hidden transition-colors duration-300 ${scrolled || !isHome ? "text-brand-primary" : "text-white"}`}>
        ...
        <div className="fixed inset-0 top-24 z-[40] bg-white animate-fade-in overflow-y-auto lg:hidden">
          <div className="p-8 space-y-10">
            {categoryGroups.map((item) => (
              <div key={item.label}>
                <h3 className="text-[10px] uppercase tracking-[0.3em] font-bold text-primary-gold mb-6">
                  {item.label}
                </h3>
